...
class AesEncryptUtil
{
    ...
    public function encrypt($text)
    {
        try {
            ...
            throw new XzhException(XzhError::getCusXzhError(XzhError::AES_ENCRYPT_ERROR, $e->getMessage()));
        }
    }
    ...
    public function decrypt($encrypted, $isCheckClientId = true)
    {
        try {
            ...
            throw new XzhException(XzhError::getCusXzhError(XzhError::AES_DECRYPT_ERROR, $e->getMessage()));
        }
        ...
        try {
            ...
            throw new XzhException(XzhError::getCusXzhError(XzhError::AES_DECRYPT_XML_ILLEGAL_ERROR, $e->getMessage()));
        }

        if ($isCheckClientId && ($fromClientId != $this->clientId)) {
            throw new XzhException(XzhError::getXzhError(XzhError::AES_DECRYPT_CLIENTID_ERROR));
        }
